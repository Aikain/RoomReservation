...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("select r from Reservation r where r.room = :room and r.startTime != :endTime and r.endTime != :startTime and (r.startTime between :startTime and :endTime or r.endTime between :startTime and :endTime or (r.startTime < :startTime and r.endTime > :endTime))")
